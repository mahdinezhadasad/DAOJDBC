...
////
////        Long saved = authorDao.saveNewAuthor(author);
////
////        authorDao.deleteAuthorById(saved.getId());
////
////        Long deleted = authorDao.getById(saved.getId());
////
////        assertThat(deleted).isNull();
////    }
//
...
////        Long updated = authorDao.updatedAuthor (saved);
////
...
//        Long author = authorDao.findAuthorByName("Craig", "Walls");
//
...
//
//        Long author = authorDao.getById(1L);
//
//        assertThat(author).isNotNull();
//
//    }
